package com.njucm.cmdh.slidemenu;
...
public class CustomViewAbove extends ViewGroup {
	...
	public int getDestScrollX(int page) {
		...
		case 0:
		case 2:
			return mViewBehind == null ? 0 : mViewBehind.getMenuLeft(mContent,
					page);
		case 1:
			return mContent == null ? 0 : mContent.getLeft();
		}
		return 0;
	}

	private int getLeftBound() {
		return mViewBehind == null ? 0 : mViewBehind.getAbsLeftBound(mContent);
	}

	private int getRightBound() {
		return mViewBehind == null ? 0 : mViewBehind.getAbsRightBound(mContent);
	}
	...
	public int getBehindWidth() {
		return mViewBehind == null ? 0 : mViewBehind.getBehindWidth();
	}
