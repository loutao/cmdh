    ...
    public void startService() {
        Thread serviceThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.v("当前系统版本号：",""+Integer.parseInt(currentAndroidVersion.substring(0, 1)));
                if(Integer.parseInt(currentAndroidVersion.substring(0, 1))>=5){
                    intent.setPackage("com.njucm.cmdh.app.androidpn");  //android5.0以上要设置
                }
