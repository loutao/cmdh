...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.njucm.cmdh.app.androidpn.NotificationService";
    ...
    public NotificationService() {
        Log.d("NotificationService:", "NotificationService's constructor is called");
    ...
    public void onCreate() {
        ...
        taskSubmitter.submit(new Runnable() {
            public void run() {
                NotificationService.this.start();  //只要启动应用，这个服务就会开启
            }
        });
    }
