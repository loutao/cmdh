...
/**
 * DAO for table HEALTHKNOWLEDGETYPE.
 */
public class HealthKnowledgeTypeDao extends AbstractDao<HealthKnowledgeType, Long> {

    public static final String TABLENAME = "HEALTHKNOWLEDGETYPE";
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'HEALTHKNOWLEDGETYPE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'HEALTHKNOWLEDGETYPE'";
        db.execSQL(sql);
    }
